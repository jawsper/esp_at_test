...
SDK_BASE	?= /opt/Espressif/sdk0.9.2
...
LIBS		= c gcc hal phy net80211 lwip wpa main upgrade
...
flash: firmware/0x00000.bin firmware/0x40000.bin
	-$(ESPTOOL2) -v -cp $(ESPPORT) -ca 0x00000 -cf firmware/0x00000.bin -ca 0x40000 -cf firmware/0x40000.bin
#	toggleDTR $(ESPPORT)
